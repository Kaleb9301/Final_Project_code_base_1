...
const adminmenuItems = [
  {
    ...
    value: routes.account.profile,
  },
  {
    label: 'Admin',
    value: routes.account.admin,
  },
      ...
      <div className="relative flex items-center overflow-hidden">
        ...
        <div className="flex h-[52px] items-start overflow-hidden">
          <div
            ...
            ref={sliderEl}
          >
            {menuItems?.map((menu: { label: string; value: string; }, index) => (
              <a
                href={`${menu.value}`}
                key={`menu-${index}`}
                className={cn(
